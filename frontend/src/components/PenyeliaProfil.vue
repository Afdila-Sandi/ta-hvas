<template>
  ...
  >
    <div class="flex items-center gap-4 mb-6 pb-6 border-b border-slate-100">
      <div
        class="w-12 h-12 rounded-full bg-amber-100 text-amber-600 flex items-center justify-center text-xl font-black shadow-sm"
      >
        <i class="fa-solid fa-user-check"></i>
      </div>
      <div>
        <h2 class="text-xl font-bold text-slate-800">Profil Penyelia</h2>
    ...
    <form @submit.prevent="updateProfile" class="space-y-5">
      ...
      <div>
        ...
        <input
          ...
          type="text"
          required
          class="w-full px-4 py-3 rounded-xl border border-slate-200 outline-none focus:ring-2 focus:ring-amber-500 font-medium text-slate-700 transition-all"
        />
      </div>
